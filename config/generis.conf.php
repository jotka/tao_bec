...
# local namespace
define('LOCAL_NAMESPACE','http://54.37.234.90/bec.rdf');

# platform identification
define('GENERIS_INSTANCE_NAME','bec');
define('GENERIS_SESSION_NAME','tao_FYl1Qn7g');

# paths
define('ROOT_PATH','/var/www/html/');
define('ROOT_URL','http://54.37.234.90/');
